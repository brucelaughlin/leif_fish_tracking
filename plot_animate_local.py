...
figures_directory = current_directory + '/z_output/figures/'
...
output_file_pre_1 = output_file_split[0]
output_file_split_2 = output_file_pre_1.split('/')
output_file_pre = figures_directory + output_file_split_2[-1]
